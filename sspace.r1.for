...
C                                                                       SSP00078 
      ...
      N1=NC + 1                                                         SSP00082 
      NC1=NC - 1                                                        SSP00083 
C     REWIND NSTIF                                                      SSP00084 
C     WRITE (NSTIF) A                                                   SSP00085 
      WRITE(*,*) A
...
C                                                                       SSP00090 
      ND=NN/NC                                                          SSP00091 
C     WRITE(*,*) A,B,MAXA,R,EIGV,TT,W,AR,BR,VEC,D,RTOLV,BUP,BLO
C     WRITE(*,*) BUPC,NN,NNM,NWK,NWM,NROOT,RTOL,NC,NNC,NITEM,IFSS
C     WRITE(*,*) IFPR,NSTIF,IOUT
C     WRITE(*,*) " OK "
C     WRITE(*,*) NN, NC, ND
C     WRITE(*,*) " -------------OK "
C     WRITE(*,*) NWM, NN
